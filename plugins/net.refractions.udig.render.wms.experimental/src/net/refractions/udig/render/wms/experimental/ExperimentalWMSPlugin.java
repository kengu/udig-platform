 ...
 *
 */
package net.refractions.udig.render.wms.experimental;
 ...
 * @since 0.6.0
 */
public class ExperimentalWMSPlugin extends AbstractUIPlugin {

    public static final String ID = "net.refractions.udig.render.wms.basic"; //$NON-NLS-1$
    private static ExperimentalWMSPlugin plugin;

    /**
     * Construct <code>WMSPlugin</code>.
     *
     */
    public ExperimentalWMSPlugin() {
        super();
        plugin=this;
    }

    public static ExperimentalWMSPlugin getDefault(){
        return plugin;
    }
    ...
    public static void log(String message, Throwable exception) {
        ExperimentalWMSPlugin.getDefault().getLog().log(
                new Status(IStatus.INFO, ExperimentalWMSPlugin.ID, IStatus.OK, 
                        message, exception));
    }    
    /**
